  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#4FB7FF] text-white flex justify-center items-center p-4'>
        <form method="POST" action={process.env.REACT_APP_GETFORM} className='flex flex-col max-w-[600px] w-full'>
            ...
            <input required className='p-2 text-black' type="text" placeholder='Name' name='name'/>
            <input required className = 'p-2 my-4 py-2 text-black' type="text" placeholder='Email' name='email'/>
            <textarea required className='p-2 text-black' placeholder='Message' name='message' rows='10'></textarea>
